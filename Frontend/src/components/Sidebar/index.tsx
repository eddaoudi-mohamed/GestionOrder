  ...
  return (
    ...
    >
      <div>
        ...
        <div className="flex items-center justify-between gap-2 px-6 pt-5.5 lg:pt-6.5">
          <NavLink className="flex justify-center" to="/dashboard">
            <img
              className="bg-white rounded-md w-3/6 h-3/6 object-cover block"
              src={Logo}
              alt="Logo"
            />
          </NavLink>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-2 py-4 px-4 lg:mt-5 lg:px-6">
            {/* <!-- Menu Group --> */}
      ...
      <div className="mb-10 mx-5">
        {/* <!-- Menu Item Chart --> */}
        <a
          className={`relative flex items-center gap-2.5 rounded-ls  px-4 font-medium text-bodydark1 duration-300 ease-in-out
           hover:bg-graydark dark:hover:bg-meta-4 dark:bg-meta-4 border border-graydark py-4`}
