  ...
  export default function ViewMenu() {
    ...
    const { order, deleteOrderDialog, orderPaidDialog, orderRefundDialog } =
    ...
    const handleRefund = async () => {
      try {
        ...
        dispatch(setRefund(refundedAmount));
        ...
        <div className="floating-container">
          ...
          <div className="element-container">
            {order.status !== "paid" && order.status !== "refunded" ? (
              <button
                className="text-white p-3 rounded-full bg-meta-3 float-element tooltip-left "
                onClick={EditOrder}
              >
