...
import { AddClient, DeleteClient, DeleteSelectedClients } from '../../app/Features/ClientSlice';
...
export default function ListClients() {
  ...
  const [deleteClientsDialog, setdeleteClientsDialog] =
  ...
  const deleteClient = () => {
    let _clients = clients?.filter((val:any) => val.id !== client.id);
  ...
  const deleteSelectedClients = () => {
    let _clients = clients?.filter((val:any) => !selectedClients.includes(val));
