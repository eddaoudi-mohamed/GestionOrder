...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-wrap justify-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap justify-center items-center ">
        <Toast ref={toast} />
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <Link className="flex justify-center  mb-5.5 " to="/">
              <img
                className="w-3/6 h-3/6 object-cover block"
                src={Logo}
                alt="Logo"
              />
            </Link>

            <p className="2xl:px-20 capitalize">
              Welcome To MEGA Dashboard ,Where Managing Your Business Is Easier
              Than Ever.
            </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className={`absolute right-4 top-3.5 rounded-full p-2 ${inputType == "text" ? "bg-blue-600 text-white " : ""} `}
                    onClick={() => {
              ...
              <div className="mb-5">
                <button
                  type="submit"
                  className={`flex items-center justify-center gap-4 w-full cursor-pointer rounded-lg border text-white border-primary bg-primary p-4 transition hover:bg-opacity-90`}
                >
                  {isLoading ? (
